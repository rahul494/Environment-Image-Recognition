...
for (k in 1:gallery.size) {
  ...
  for (i in 1:3) {
    ...
    X[k, (2 + 9 * (i - 1))] <-
      median(mat_split(img[, , i], round(dim(img[, , i])[1] / 3), dim(img[, , i])[2])[, , 1][, 4:6])
    X[k, (3 + 9 * (i - 1))] <-
      median(mat_split(img[, , i], round(dim(img[, , i])[1] / 3), dim(img[, , i])[2])[, , 1][, 7:9])
    X[k, (4 + 9 * (i - 1))] <-
      median(mat_split(img[, , i], round(dim(img[, , i])[1] / 3), dim(img[, , i])[2])[, , 2][, 1:3])
    X[k, (5 + 9 * (i - 1))] <-
      median(mat_split(img[, , i], round(dim(img[, , i])[1] / 3), dim(img[, , i])[2])[, , 2][, 4:6])
    X[k, (6 + 9 * (i - 1))] <-
      median(mat_split(img[, , i], round(dim(img[, , i])[1] / 3), dim(img[, , i])[2])[, , 2][, 7:9])
    X[k, (7 + 9 * (i - 1))] <-
      median(mat_split(img[, , i], round(dim(img[, , i])[1] / 3), dim(img[, , i])[2])[, , 3][, 1:3])
    X[k, (8 + 9 * (i - 1))] <-
      median(mat_split(img[, , i], round(dim(img[, , i])[1] / 3), dim(img[, , i])[2])[, , 3][, 4:6])
    X[k, (9 + 9 * (i - 1))] <-
      median(mat_split(img[, , i], round(dim(img[, , i])[1] / 3), dim(img[, , i])[2])[, , 3][, 7:9])
  }
